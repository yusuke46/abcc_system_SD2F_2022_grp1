      ...
      <div class="row">
        <div class="col-12 offset-md-3 col-md-6"><!--col-md-7 col-lg-8-->
          <form action="register_confirm.php" name="myForm" class="validationForm" method="post"  onsubmit="return cancel()">
            <!--<div class="row g-3">-->
              <div class="col-12">
                <label for="user" class="form-label">お客様名（全角）</label>
                <input type="text" class="form-control" id="name" name="user">
                <p id="name_error"></p>
              </div>
              <div class="col-12">
                <label for="usernamek" class="form-label">お客様名（カナ）</label>
                <input type="text" class="form-control" id="namekana" name="usernamek">
              ...
              <div class="col-12">
                ...
                <input type="password" class="form-control" id="pa" name="pa">
                <p id="pa_error"></p>
              </div>
